            ...
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" id="formEdit">
                    ...
                    <div class="mb-3">
                        ...
                        {{-- <input type="text" class="form-control input-modal text-limit" id="descriptionEDIT"
                            name="description" aria-describedby="description_help" minlength="1" maxlength="500"> --}}

                        <textarea name="description" id="descriptionEDIT" cols="30" rows="10" onkeyup="countChar(this)"
                            class="form-control input-modal text-limit" minlength="1" maxlength="500"></textarea>

                        <span class="text-danger editmodal_error" id="description_errorEDITMODAL"></span>
                        <span class="text-danger d-none" id="text-limit_errorEDIT">Se ha alcanzado el limite de
                            texto.</span>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3 mt-2">
                        <label for="image_productEDIT" class="fw-light">Puedes cambiar la imagen si lo
                            deseas.</label>
