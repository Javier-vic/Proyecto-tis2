<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-default-primary">
        <button type="button" class="btn-view-producto dropdown-item text-main" value="{{ $_id }}" data-toggle="modal"
            ...
            detalles</button>
            <button type="button" onclick="editProduct({{$_id}})" class="dropdown-item  " ><i class="fa-solid fa-pen-to-square"></i> Editar producto</button>
            <button type="button" onclick="deleteProduct({{$_id}})" class="dropdown-item text-danger" ><i class="fas fa-trash-alt | text-danger | p-1"></i>Eliminar</button>
