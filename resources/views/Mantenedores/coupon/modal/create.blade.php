            ...
            <div class="modal-body">
                <form onsubmit="createCoupon(event)" method="POST" enctype="multipart/form-data" id="formCreate">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex">
                            <input type="range" class="form-range input-modal" id="percentage" name="percentage"
                                aria-describedby="stock_help" value="1" min="1" max="100" step="1" oninput="percentageAmount.value=percentage.value" />
                            <input class="ms-3" id="percentageAmount" type="number" value="1" min="1" max="100" oninput="percentage.value=percentageAmount.value" />
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control input-modal" id="quantity" name="quantity" 
