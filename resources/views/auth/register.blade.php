            ...
            <form method="POST" onsubmit="createUser(event)" enctype="multipart/form-data" class="m-0 p-0">
                ...
                <div class="row mb-3">
                    <div class="col-md-6 mx-auto  @if (isset($user)) d-none @endif">
                        ...
                        <input id="name" type="text" class="form-control input-modal" name="name"
                ...
                <div class="row mb-3 ">
                    <div class="col-md-6 mx-auto  @if (isset($user)) d-none @endif"">
                        ...
                        <input id="email" type="text" class="form-control input-modal" name="email"
                            autocomplete="email "
                ...
                <div class="row mb-3">
                    <div class="col-md-6 mx-auto ">
                        ...
                        <input id="address" type="text" class="form-control input-modal" name="address"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 mx-auto">
                        <label for="phone" class="">{{ __('Número') }}</label>
                ...
                <div class="row mb-3  @if (isset($user)) d-none @endif">
                    <div class="col-md-6 mx-auto">
                        <label for="password" class="">{{ __('Contraseña') }}</label>
                        <div class="d-flex">
                            <input id="password" type="password" class="form-control input-modal" name="password"
...
@section('js_after')
    ...
    <script>
        window.addEventListener("beforeunload", function(event) {
            ...
            event.returnValue = "jajaxd ayuda"; //"Any text"; //true; //false;
